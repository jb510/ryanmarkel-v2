...
function harmonic_setup() {
	...
	add_image_size( 'featured-image', 1024, 9999 );
...
function harmonic_enqueue_backstretch() {
	...
	wp_enqueue_script( 'backstretch', get_stylesheet_directory_uri() . '/js/jquery.backstretch.js', array( 'jquery' ), '1.0.0' );
	wp_enqueue_script( 'backstretch-set', get_stylesheet_directory_uri() .'/js/harmonic-backstretch.js' , array( 'jquery', 'backstretch' ), '1.0.0' );
	wp_localize_script( 'backstretch-set', 'BackStretchImg', array(
			'src' => $headerimage ) );
}
